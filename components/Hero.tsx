...
const Hero = () => {
  return (
    <div className="h-[700px] w-full bg-skyBlue max-lg:h-[900px] max-md:h-[750px]">
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          <h1
            className="text-6xl text-black font-bold mb-3 max-xl:text-5xl max-md:text-4xl max-sm:text-3xl">
            THE PRODUCT OF THE FUTURE
          </h1>

          <p className="text-3xl text-yellow max-sm:text-sm">
          ...
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <button className="bg-gray text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-skyBlue">
              BUY NOW
            </button>
            <button className="bg-gray text-blue-600 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-skyBlue">
              LEARN MORE
